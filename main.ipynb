 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "# Nessa variavel podemos colocar read.sql para ler direto de um banco de dados se for o caso.\n",
    "# No caso, como estou usando uma base de dados ficticea no EXCEL, vou usar .CSV \n",
    "\n",
    "display(tabela)\n",
    "# Essa visualização da tabela de forma organizada, só esta sendo possivel pois estou usando um arquivo .IPYNB .\n",
    "# Se por um acaso eu estivesse usando um arquivo .py eu teria que usar o ('print') e ela não ficaria organizada assim"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    "display(tabela.info())\n",
    "#esse comando eu usei para exibir algumas informações relativas a minha tabela de forma \"resumida\"\n"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# Algumas colunas dessa tabela estao como \"object\" porem precisamos transforma-las em \"int64\" que são números\n",
    "# para isso vou importar uma ferramenta chamada LabelEncode que realiza essa transformação\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    "\n",
    "# Vou criar uma variavel par atransformar as colunas em numeros \n",
    "\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Acima você pode verificar que tratei a base de dados deixando apenas a coluna \"SCORE_CREDITO\" com o tipo object\n",
    "# Agora precisamos pensar qual ou quais as colunas do banco nós queremos prevê\n",
    "# Nesse caso quero que ela preveja a coluna do score de credito e saber se é boa,ruim ou ok \n",
    "# Para fazer isso, vamos dividir a base de dados em partes, nesse caso vou dividir em 2 (X e Y)\n",
    "# \"X\" = todas as colunas que a IA vai usar para prever a coluna \"Y\"\n",
    "# \"Y\" = a coluna que a IA irá prever  = SCORE_CREDITO\n",
    "\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Agoea vamos dividir nossa base de dados em X_treino y_treino e x_teste y_teste\n",
    "# para que nossa IA possa aprender e posteriormente ser testada\n",
    "# Para isso vou importar outra ferramenta chamada: train_test_split\n",
    "# Essa ferramenta vai dividir nossa base de dados em dados de treino e dados de teste \n",
    "\n",
    "\n",
    "from sklearn.model_selection import train_test_split\n",
    "\n",
    "x_treino, x_teste, y_treino, y_teste = train_test_split(x, y)\n",
    "# É muito importante que a ordem seja exatamente essa: x_treino, x_teste, y_treino, y_teste, pois\n",
    "# é exatamente assim que a ferramenta\n",
    "# OBS. Por padrão temos que colocar mais dados de treino do que dados de teste."
   ]
  },
  {
   "cell_type": "markdown",
   "metadata": {},
   "source": [
    "# CRIAR O MODELO DE IA -> PREVÊ O SCORE_CREDITO: BOM, RUIM, OK"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# VOU USAR DOIS MODELOS DE IA PARA ML\n",
    "\n",
    "# 1- KNN (cuja sigla significa KNowledge Now)\n",
    "# 2- RANDOM FOREST (conhecida tambem como árvoce de decisão)\n",
    "\n",
    "# Para usar IA para ML temos 3 pontos principais para seguir\n",
    "\n",
    "\n",
    "# 1 - IMPORTAR:\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    "# Agora vou testar as duas IA's para ver qual vou escolher, para isso vou submetelas aos TESTES\n",
    "\n",
    "previsao_arvoredecisao = modelo_arvoredecisao.predict(x_teste)\n",
    "previsao_knn = modelo_knn.predict(x_teste)\n",
    "\n",
    "# Com base nesses testes vamos apurar o percentual de acerto de cada uma\n",
    "# para isso nós vamos usar a acurácia que é = aaccuracy em ingles \n",
    "# primeiro vamos importar essa acurácia (essa funcão compara o percentual de acerto de cada uma)\n",
    "\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# De acordo com o teste realizado o modelo:\n",
    "\n",
    "# arvore_decisao teve um acerto de: + ou - 83% de acerto \n",
    "# a KNN por sua vez, teve + ou - 74% de acerto "
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# O Proximo passo é criar o processo de DEPLOY -> Essa fase é essencial, pois é quando o código\n",
    "# desenvolvido passa a ser acessível para os usuários finais\n",
    "# provavelmente usarei uma ferramente chamada STREAMLIT -> DOCUMENTAÇÃO -> https://docs.streamlit.io/"
   ]
  }
 ],
 "metadata": {
